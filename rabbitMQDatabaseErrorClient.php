...
$filename = '/home/lord-byron/git/rabbitmqphp_example/dbLogs.txt';
//Open dbLog file and append contents to an array
if (file_exists($filename)){
	echo "This file $filename exists"."<br>";
	$file = fopen("/home/lord-byron/git/rabbitmqphp_example/dbLogs.txt","r");
$errorArray = [];
while(! feof($file)){
...
$fp = fopen("/home/lord-byron/git/rabbitmqphp_example/dbLogs.txt", "a");
for($i = 0; $i < count($errorArray); $i++){
        fwrite($fp, $errorArray[$i]);
}
file_put_contents("/home/lord-byron/git/rabbitmqphp_example/dbLogs.txt", "");
